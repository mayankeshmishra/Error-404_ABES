                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            $busRef = $db->collection($c)->document($b);
                                            $x = $busRef->snapshot();
                                            if ($x != null) {

                                                $s = $x->get("Stops");
                                                foreach ($s as $row) {
                                                    array_push($finalStops, $row["StopName"]);
                                                    strval($i);
                                            ?>
                                                    <tr>
                                                        <td>
                                                        <td colspan='3'></td>
                                                        <td><?php echo $row["StopName"] . '<br>'; ?></td>
                                                        <td colspan='6'>
                                                            <form method="post">
                                                                <div class='row'>
                                                                    <div class='col-md-8'>
                                                                        ...
                                                                        ?>
                                                                        <select class="form-control" name=<?php echo "new_stop" . $i ?>>
                                                                            <option>New Stop</option>
                                                                            <?php foreach ($stop_s as $d) {
                                                                            ?>
                                                                                <option><?php echo $d['Name']; ?></option>
                                                                            <?php } ?>
                                                                        </select>
                                                                    </div>
                                                                    <button type='submit' class='btn btn-primary pull-right' name=<?php echo "post" . $i ?>>Edit</button>
                                                ...
                                                for ($j = 0; $j < $i; $j++) {
                                                    if (isset($_POST["post" . $j])) {
                                                        $new_stop = $_POST["new_stop" . $j];

                                                        $docRef = $db->collection($c)->document($b);
                                                        $snapshot = $docRef->snapshot();
                                                        if ($snapshot->exists()) {
                                                            $a = $snapshot->get('Stops');
                                                            foreach ($a as $as) {
                                                                array_push($n_stops, $as['StopName']);
                                                            }
                                                            $a = $n_stops[$j];
                                                            $n_stops[$j] = $new_stop;
                                                            $new_stop = $a;
                                                        ...
                                                        for ($k = 0; $k < $s; $k++) {
                                                            ...
                                                            array_push($arr, $stops);
                                                        }

                                                        $docRef = $db->collection($c)->document($b);
                                                        $docRef->update([
                                                            ['path' => 'Stops', 'value' => $arr],
                                                        ]);
                                                        echo '<script language="javascript">';
                                                        echo 'alert("Updated Successfully");';
                                                        echo 'window.location.href="edit_bus.php";';
                                                        echo '</script>';
                                                    }
                                                }
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form action="store_new_stops.php" method="post" id="container">
                                                            <div class='row'>
                                                                <button type='submit' class='btn btn-primary pull-right' name='post1'>ADD</button>
                                                                <div class='col-md-8'>
                                                                ...
                                                                <!-- <button type='button' class='btn btn-primary pull-right' id="filldetails" onclick="addFields()">Fill Details</button> -->
