          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-body">
                  <form action="bus_store.php" method="post">
                    <div class="row">
                      <div class="col-md-3">
                      ...
                      <div class="col-md-2">
                        <div class="form-check form-check-inline">
                          <input class="form-input" type="radio" name="ac" id="inlineRadio1" value="yes">
                          <label class="form-check-label" for="inlineRadio1">AC</label>
                        </div>
                        <div class="form-check form-check-inline">
                          <input class="form-input" type="radio" name="ac" id="inlineRadio2" value="no">
                      ...
                      <div class="col-md-3">
                        <div class="form-group">
                          <label class="bmd-label-floating">No. of Stops</label>
                          <input type="text" id="member" name="member" value="" class="form-control" required></br>
                          <a href="#" id="filldetails" onclick="addFields()">Add Stops</a>
                        </div>
                      </div>
                    </div>
                    <div class="row">
